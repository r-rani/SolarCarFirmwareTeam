...
# 6 "./button_functionality.h" 2

void buttonRuntime(int*,int*);
void leftTurnButton(int*);
void rightTurnButton(int*);
void hazardButton(int*);
# 3 "button_functionality.c" 2

void buttonRuntime(int* b1v,int* b10v) {
    leftTurnButton(b1v);
