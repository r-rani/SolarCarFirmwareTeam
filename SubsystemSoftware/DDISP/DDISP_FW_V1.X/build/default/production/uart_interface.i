...
# 5 "./uart_interface.h" 2



void leftTurnIndicator(int);
void rightTurnIndicator(int);
void warningLED1(int);
void warningLED2(int);
void motorSpeed(int);
void motorControlerTemp(int);
...
void motorControlerTemp(int value){
